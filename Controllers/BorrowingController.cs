...
namespace CooperativeOffice.Controllers
{
    public class BorrowingController : Controller
    {
        ...
        public ActionResult Show(string code, string euid, string returnurl, int key = 0)
        {
            ...
            var model = new DBopreator().GetBorrowingById(code);
        ...
        /// </summary>
        /// <returns></returns>
        public JsonResult GetBorrowingById(string id)
        {
            return Json(new DBopreator().GetBorrowingById(id), JsonRequestBehavior.AllowGet);
        }
        /// <summary>
        /// 获取草稿
        /// </summary>
        ...
        {
            return Json(new DBopreator().GetBorrowingDraft(orgeuid, euid), JsonRequestBehavior.AllowGet);
        }
        /// <summary>
        /// 保存审批操作
        /// </summary>
        ...
        /// <returns></returns>
        public JsonResult Save(BorrowingModels param)
        {
            return Json(new DBopreator().SaveBorrowing(param));
        }
        /// <summary>
        /// 保存草稿
        /// </summary>
        /// <param name="param"></param>
        /// <returns></returns>
        public JsonResult SaveDraft(BorrowingModels param)
        {
            return Json(new DBopreator().SaveBorrowingDraft(param));
        }
        /// <summary>
        /// 发送催办通知
        /// </summary>
